...
public class RestClient {
    ...
    public RestClient(String url, Map<String, Object> params, String downloadDir,
                      String extension,
                      String name, IRequest request, ISuccess success, IFailure failure, IError error, RequestBody body, File file, Context context, LoaderStyle loaderStyle) {
        this.URL = url;
    ...
    private void request(HttpMethod method) {
        ...
        switch (method) {
            ...
            case UPLOAD:
                ...
                call = RestCreator.getRRestService().upload(URL, body);
                break;
            default:
                break;
        }
